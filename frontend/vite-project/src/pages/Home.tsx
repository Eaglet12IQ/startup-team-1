          ...
          <main className="flex-1 flex items-center justify-center px-4 sm:px-8">
            <div className="text-center max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                <Link
                    to="/register"
                    className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-[#0071e3] text-white rounded-full font-medium hover:bg-[#0077ED] transition-all duration-200 shadow-[0_4px_12px_rgb(0,113,227,0.3)] text-base sm:text-lg"
                >
                  Начать бесплатно
                </Link>
