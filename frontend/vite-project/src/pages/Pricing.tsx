...
const plans = [
  {
    ...
    price: '0',
    period: 'навсегда',
    features: ['Одно табло', 'До 10 элементов на экран', 'Экспорт в JSON', 'Ограничение 10 МБ на загрузку своих изображений'],
    current: true,
  },
  {
    name: 'Бизнес',
    ...
    features: [
      ...
      'Готовые шаблоны меню и рекламы',
      'Быстрое обновление через веб-интерфейс',
      'API интеграции',
      'Ограничение 1 ГБ на загрузку своих изображений',
      'Доступ к AI-асистенту'
    ],
    current: false,
  }
];
