...
const plans = [
  {
    ...
    price: '0',
    period: 'навсегда',
    features: ['1 образ ОС', '3 базовых шаблона', 'Предпросмотр на сайте'],
    current: false,
  },
  {
    name: 'PRO',
    ...
    period: 'разово',
    features: [
      'Все шаблоны + индивидуальные',
      'Неограниченное количество образов',
      'Локальное редактирование через Wi-Fi',
      'Расширенная загрузка медиа',
    ],
    current: true,
  },
  {
          ...
          <main className="max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-16">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-base sm:text-xl text-[#6e6e73]">
                Гибридная монетизация: разовая покупка + подписка
              </p>
            </div>
